...
export default function GraphPage() {
  ...
  const nodeCount = graphData?.nodes.length || 6;
  const linkCount = graphData?.links.length || 5;
        ...
        <section className="glass-panel border border-white/10 p-6 md:p-8">
          ...
          <div className="mt-5 max-w-2xl">
            ...
            <p
              ...
              style={{ color: "#c5c7c9" }}
            >
              The graph is the hidden structure behind Le Mem. Every new memory
            ...
            <div className="mt-5 space-y-3">
              {LEGEND.map(([label, color]) => (
                ...
                >
                  ...
                  />
                  <span className="text-body-md" style={{ color: "#c5c7c9" }}>
                    {label}
                  </span>
                </div>
              ))}
